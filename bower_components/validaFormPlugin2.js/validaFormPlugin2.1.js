(function($){
	...
	$.fn.validaForm = function (opciones){

		var selector = $(this);

		console.log('ejecutando validaForm en '+this[0].id);

		//min_width,icons,barra,pariente
		...
		$(".form-control").change(function(event) {
			...
			if(($(this)[0]["value"]=="") && ($(this)[0]["required"] == true)){
	            ...
	            if (ajustes.pariente == 'dad') {
	            	padre.attr('class', 'form-group has-error has-feedback');
	            } else if (ajustes.pariente == 'grandpa'){
				...
				if ( ( (progreso == 0) || (progreso < 100) ) && ($(this).attr('pasoValida') == 0) ) {
					...
					if (ajustes.barra == true) {
						contador(pro_form_cont,matematica_progress(ajustes.min_width));
					};
