		...
		function render(){
			...
			foreach ($this->array_data as $llave => $valor) {
				...
				foreach ($this->array_permit as $ll => $val) {
					...
					//Valida el array campo "href" para poner valor o no
					if(isset($this->array_options["href"])){
					...
					//Valida el array campo "class" para poner valor o no
					if(isset($this->array_options["class"])){
						$class = $this->array_options["title"];
					} else {
						$class = '';
					}	

					echo "<td "."title='".$title."' href='".$href."' class='".$class."' >";
					//--------------------------------------------------------------------------------------
