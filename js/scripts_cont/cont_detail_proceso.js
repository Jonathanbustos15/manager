$(function(){
	...
	function getDocumentosTree(){

		var pkID_proceso = $("#id_proceso").val();

		//-----------------------------------------------------------------------------------------------

		var consulta_documentos = "select documentos_proceso.*, tipo_documento_proceso.nombre_tdoc as nom_tipoDocumento"+ 

								" FROM `documentos_proceso`"+ 

								" INNER JOIN tipo_documento_proceso ON tipo_documento_proceso.pkID = documentos_proceso.fkID_tipo"+ 

								" where fkID_proceso = "+pkID_proceso;
	    $.ajax({
	        url: '../controller/ajaxController12.php',
	        data: "query="+consulta_documentos+"&tipo=consulta_gen"
	    })
	    .done(function(data) {	    	
