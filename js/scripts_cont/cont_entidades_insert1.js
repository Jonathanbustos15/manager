$(function(){
		...
		$("#not_entidades_modal").html("");
	     ...
	     //validaBtnGuardar();
	  	...
	  	$("#nombre_entidad").keyup(function(event) {
			...
			validaCampoLike.setup("nombre_entidad","entidades",$(this).val())

			validaCampoLike.valida()
	...
	*/
	$("#btn_actionentidad").click(function(){
		...
		if (validaCampoLike.test) {
			action = $(this).attr("data-action");
			valida_action(action);
			console.log("accion a ejecutar: "+action); 
		} else {
			alert("Esta entidad no se puede crear porque existen entidades con nombre similar. Por favor verifique en intételo de nuevo.")
		}		
