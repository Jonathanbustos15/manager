  ...
  <div class="row">
    ...
    <!-- permisos para gastos -->
      ...
      <ul class="nav nav-tabs proy-doc2" role="tablist">
        ...
        <li id="li_gastos" role="presentation" <?php if ($consProy_gastos != 1){echo 'style="display: none;"';} ?> ><a href="#gastos" aria-controls="gastos" role="tab" data-toggle="tab">Gastos</a></li>
        <li id="li_ingresos" role="presentation" <?php if ($consProy_ingresos != 1){echo 'style="display: none;"';} ?> ><a href="#ingresos" aria-controls="ingresos" role="tab" data-toggle="tab">Ingresos</a></li>
        <!--  -->
      </ul>
          ...
          <br>
            ...
            <div class="panel panel-default proyec-marg5">
              ...
              <div class="panel-heading">
                <div class="row">
                  <div class="col-md-6">
                      Registro de Ingresos al proyecto
                  </div>
                  <div class="col-md-6 text-right">
              ...
              <div class="dataTable_wrapper table-responsive">
                  <table class="table table-striped table-bordered table-hover" id="tbl_ingresosProyecto">
                      <thead>
                          <tr>                              
                              <th class="tabla-form-ancho">Beneficiario</th>                                            
                              <th class="tabla-form-ancho">Descripcion</th>
                      ...
                      <tbody>
                          <?php $ingresos_gralInst->getTablaingresos_gralProyecto($pkID); ?>
                      </tbody>
                  </table>
                  <hr>
                  <div class="col-md-6"></div>
                  <div class="col-md-6">                            
                      <label for="total_ingresosProyecto" class="control-label">Total Ingresos</label>                                
                      <div class="input-group">
                        <span class="input-group-addon">$</span>
                        <input type="text" class="form-control" id="total_ingresosProyecto" name="total_ingresosProyecto" readonly="true" value=<?php $ingresos_gralInst->getSumaingresosValProyecto($pkID); ?>>
                      </div>
                  </div>
              </div>
