        ...
        <form id="form_reunion" class="form-horizontal" method="POST">                
            <br>
                ...
                <div class="form-group">
                    <label for="fecha_realizacion" class="col-sm-1 control-label">Fecha</label>
                    <div class="col-sm-4">                        
                        <input type="text" class="form-control" id="fecha_realizacion" name="fecha_realizacion" placeholder="fecha realización" required = "true">                        
                    </div>
                    <label for="fkID_moderador" class="col-sm-1 control-label label-block">Moderador</label>
                    <div class="col-sm-6">
                       <?php 
